...
var _likedSvg = require("./liked.svg");
var _likedSvgDefault = parcelHelpers.interopDefault(_likedSvg);
var _shapeSvg = require("./shape.svg");
var _shapeSvgDefault = parcelHelpers.interopDefault(_shapeSvg);
...
function reset() {
    _view.UI_ELEM.FORM.reset();
}
_view.UI_ELEM.FORM.addEventListener('submit', (event)=>{
    event.preventDefault();
    _view.UI_ELEM.NOWS__LIKE.setAttribute('src', `${_shapeSvgDefault.default}`);
...
function createNewElement(city) {
    ...
    cityElement.addEventListener('click', ()=>{
        _view.UI_ELEM.NOWS__LIKE.setAttribute('src', `${_likedSvgDefault.default}`);
        _view.UI_ELEM.INPUT_NAME.classList.remove('error');
...
},{"./tab":"h3Yr9","./storage":"j1l1C","./view":"2GA9o","js-cookie":"c8bBu","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./liked.svg":"bBdxr","./shape.svg":"2kR3m"}],"h3Yr9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"bBdxr":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('1pq9E') + "liked.6a87faf7.svg" + "?" + Date.now();
...
},{}],"2kR3m":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('1pq9E') + "shape.59c8dac9.svg" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}]},["aIdiY","bDbGG"], "bDbGG", "parcelRequire756d")
